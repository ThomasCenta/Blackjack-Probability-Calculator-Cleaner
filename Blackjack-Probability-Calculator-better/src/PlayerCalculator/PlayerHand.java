...
/**
   ...
   */
  public int compare13(PlayerHand otherHand) {
   ...
   * @requires otherHand != null
   */
  public int compare10(PlayerHand otherHand) {
	  assert otherHand != null;
    int toReturn = 0;
   ...
   */
  public boolean isSubset10(PlayerHand otherHand) {
